define(["underscore", "backbone", "react", "jsx!cAlert", "jsx!cLoading"],function(_, Backbone, React, cAlert, cLoading){
    'use strict';
    var koala = {},
        root = window;
    /**
...
/*        pageTransition: {
        ...
        ,navigate: function(route,trigger,replace){
            ...
            if(trigger === undefined || trigger == true){
                return Backbone.history.navigate(route, {trigger:true,replace: replace});
            }else{
                return Backbone.history.navigate(route, {trigger:false,replace: replace});
            }
        }
    });
    ...
    koala.cBaseview = Backbone.View.extend({
        ...
        ,Show: function(params){
            ...
            if(fromViewEl && toViewEl && inClass && backClass){
